...
export class CardsContainerComponent {
  ...
  sortASCPriceBtnText: string = "Від дешевих до дорогих";
  sortDESCPriceBtnText: string = "Від дорогих до дешевих";
  noSearchResultTxt: string = "Нічого не знайдено!"
  ...
  searchByName(search: string) {
    this.products = this.productService.filterProductsByName(search);
    this.isSearchErr = !this.products.length;
  }

  sortByPrice(isDesc: boolean) {
    this.products = this.productService.sortByPrice(isDesc);
  }
